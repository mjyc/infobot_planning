...
#include <infobot_map_msgs/GetProbabilityMap.h>
...
private:
  ...
  bool surfaceCallback(infobot_find_viewpoint_msgs::GetProbabilityOctomapSurface::Request  &req,
                       infobot_find_viewpoint_msgs::GetProbabilityOctomapSurface::Response &res);
  bool heightCallback(infobot_find_viewpoint_msgs::GetProbabilityOctomapHeight::Request  &req,
                      infobot_find_viewpoint_msgs::GetProbabilityOctomapHeight::Response &res);

  bool applyProbabilityMapToOctomapSurface(const infobot_map_msgs::ProbabilityGrid &pmap,
                                           int probValOffset,
                                           octomap::OcTree* octree);
  bool applyProbabilityMapToOctomapHeight(const infobot_map_msgs::ProbabilityGrid &pmap,
                                          int probValOffset,
                                          double heightMean,
                                          double heightVar,
                                          octomap::OcTree* octree);
                                                    ...
                                                    infobot_map_msgs::ProbabilityGrid &pmap)
{
  ...
  ros::ServiceClient getProbabilityMapClient = nh_.serviceClient<infobot_map_msgs::GetProbabilityMap>("/get_pmap");
  infobot_map_msgs::GetProbabilityMap getProbabilityMapSrv;
                                             ...
                                             octomap_msgs::Octomap &octomap)
{
  ...
  ros::ServiceClient getOctomapClient = nh_.serviceClient<infobot_map_msgs::GetOctomap>("/get_octomap");
  infobot_map_msgs::GetOctomap getOctomapSrv;
...
bool ProbabilityMapToOctomapNode::surfaceCallback(
  infobot_find_viewpoint_msgs::GetProbabilityOctomapSurface::Request  &req,
  infobot_find_viewpoint_msgs::GetProbabilityOctomapSurface::Response &res)
{
...
bool ProbabilityMapToOctomapNode::heightCallback(
  infobot_find_viewpoint_msgs::GetProbabilityOctomapHeight::Request  &req,
  infobot_find_viewpoint_msgs::GetProbabilityOctomapHeight::Response &res)
{
  std::string pmap_filename = req.pmap_filename;
  std::string pmap_frame_id = req.pmap_frame_id;
...
bool ProbabilityMapToOctomapNode::applyProbabilityMapToOctomapSurface(
  const infobot_map_msgs::ProbabilityGrid &pmap, int probValOffset, octomap::OcTree* octree)
{
...
bool ProbabilityMapToOctomapNode::applyProbabilityMapToOctomapHeight(
  const infobot_map_msgs::ProbabilityGrid &pmap, int probValOffset, double heightMean, double heightVar,
  octomap::OcTree* octree)
{
  if (!validateFloats(pmap))
  {
